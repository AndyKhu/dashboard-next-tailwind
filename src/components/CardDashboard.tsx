...
const CardDashboard = ({title,value,icon,iconfa}:{title:string,value:string,icon?:string,iconfa?:string}) => {
    return (
        <div className="p-2">
            <Card className="group/item cursor-pointer">
                ...
                <div className='rounded-full primary w-12 h-12 flex items-center justify-center group-hover/item:animate-bounce'>
